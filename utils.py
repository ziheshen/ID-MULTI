...
def train_parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=json.loads,
        default=None,
        help="Question for the subject feature"
    )
    parser.add_argument(
        "--validation",
        type=bool,
        default=True,
        help="Whethere or not use validation to generate the images.",
    )
    parser.add_argument(
        "--validation_prompt",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="If the subject number is 1 and you want to change the position of the subject blip2 embedding in the text prompt, you can change it."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--loss_1",
        type=float,
        help="The weight of Loss_1"
    )
    parser.add_argument(
        "--loss_2",
        type=float,
        help="The weight of Loss_2"
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
